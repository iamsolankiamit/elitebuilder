...
import { Crown, Trophy, Medal, Star, TrendingUp, Calendar, Filter } from 'lucide-react'
import { 
  LeaderboardResponse, 
  LeaderboardEntry, 
  LeaderboardPeriod, 
        ...
        <div className="container mx-auto py-8 space-y-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Top builders ranked by their performance across all challenges
            </p>
          </motion.div>
